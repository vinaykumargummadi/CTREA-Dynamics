from libaries import StandardScaler,SimpleImputer
scaler_obj = StandardScaler()
import joblib
import pickle
import pandas as pd

#featuers used for the recommendation model
...
1. Loading the model
2. passing paramters:
    - user_data        : Data read from the user refer feature names what data is being used
    - path             : Path to pickle file
    - processed_data   : Original dataframe (pipeline.csv) loaded scaled, imputed, encoded
    - regression_value : Out of the regression model.
'''
